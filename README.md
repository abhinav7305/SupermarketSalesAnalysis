...
This project uses the public [Supermarket Sales dataset on Kaggle](https://www.kaggle.com/datasets/markmedhat/supermarket-sales). Download the CSV named supermarket_sales - Sheet1.csv before running the analysis. The source has 1,000 transactions from three branches in Yangon, Mandalay, and Naypyitaw.
